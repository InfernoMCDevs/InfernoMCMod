...
public class RankManager extends FreedomService
{
    ...
    public Displayable getDisplay(CommandSender sender)
    {
        ...
        if (FUtil.IMCDEVS.contains(player.getName()))
        {
            return Title.IMCDEV;
        }
        if (player.getName().equals("SpringPhoenix"))
        {
            return Title.OWNER;
        }
    ...
    public void onPlayerJoin(PlayerJoinEvent event)
    {
        ...
        // Set display
        if (isAdmin || FUtil.TFDEVS.contains(player.getName()) && isAdmin || FUtil.IMCDEVS.contains(player.getName()))
        {
