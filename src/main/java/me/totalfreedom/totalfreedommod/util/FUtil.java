...
public class FUtil
{
    ...
    public static final List<String> TFDEVS = Arrays.asList("Madgeek1450", "Prozza", "Wild1145", "WickedGamingUK", "aggelosQQ"); //these names are the actual TOTALFREEDOMMOD developers all credit goes to them
    public static final List<String> IMCDEVS = Arrays.asList("heroguy42");
